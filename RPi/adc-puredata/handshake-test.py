...
from bluepy.btle import UUID, Peripheral, BTLEDisconnectError, BTLEInternalError, Characteristic

led = PWMLED(13)

ESP_MAC_ADDR = "a4:cf:12:02:c3:6e"
DEVICE_RESPONSE = btle.UUID("0000181a-0000-1000-8000-00805f9b34fb")
